...
class ManagementUtils:
    ...
    def create_excepted_event_and_check(management: Management, collector: Collector, malware_name, expected_result):
        ...
        events = management.admin_rest_api_client.events.get_security_events(validation_data={"process": malware_name},
    ...
    def validate_exception(management: Management, process: str, event_id=None, group='All Collector Groups',
        ...
        exceptions = management.admin_rest_api_client.exceptions.get_exceptions(event_id)
