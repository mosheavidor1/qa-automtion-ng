...
class ExceptionsTests:
    ...
    @pytest.mark.parametrize('xray, exception_function_fixture',
                             ...
                             indirect=True)
    @pytest.mark.exceptions_windows_collector
    @pytest.mark.exceptions_windows_collector_sanity
    @pytest.mark.exceptions_linux_collector
    @pytest.mark.exceptions_linux_collector_sanity
    @pytest.mark.e2e_windows_collector_sanity
    @pytest.mark.e2e_windows_collector_sanity_parallel
    @pytest.mark.e2e_linux_collector_sanity
    @pytest.mark.e2e_linux_collector_sanity_parallel
