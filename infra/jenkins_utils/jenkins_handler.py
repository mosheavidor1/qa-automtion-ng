...
class JenkinsHandler:
    ...
    def __init__(self,
                 ...
                 jenkins_url=third_party_details.JENKINS_URL):  # full url with port
    ...
    def wait_for_build_concrete_state(self,
        ...
        assert build_concrete_state != 'None', f"Failed to get build concrete state within timeout of {timeout}, seems like the job did not finished"
