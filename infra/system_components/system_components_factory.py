...
class SystemComponentsFactory:
    ...
    def get_aggregators(management: Management) -> List[Aggregator]:
        aggr_list = []
        aggregators = management.rest_api_client.get_aggregator_info()
    ...
    def get_cores(management: Management) -> List[Core]:
        core_list = []
        cores = management.rest_api_client.get_core_info()
    ...
    def get_collectors(management: Management,
        ...
        collector_list = []
        collectors = management.rest_api_client.get_collector_info()
