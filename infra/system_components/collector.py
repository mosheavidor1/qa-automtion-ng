...
FILENAME_EDR_RUNNER = "testerRunner.py"
FILENAME_EDR_CONFIG = "edrTester.py"
...
class CollectorAgent:
    ...
    @abstractmethod
    def upgrade_collector(self, desired_version: str, registration_password: str):
        pass

    @abstractmethod
    def uninstall_collector(self, registration_password: str, stop_collector: bool = False, expect_to_succeed: bool = True):
        pass
    ...
    @allure.step("Preparation of EDR event tester working path")
