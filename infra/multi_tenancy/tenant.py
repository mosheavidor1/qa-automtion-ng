...
from infra.api.api_object_factory.system_events_factory import SystemEventsFactory
from infra.api.api_object_factory.system_events_factory import SystemEventsFactory
...
from infra.api.management_api.system_events import SystemEvent
...
class TenantRestComponentsFactory:
    ...
    def __init__(self, organization_name: str, rest_client: RestCommands):
        ...
        self.system_event: SystemEventsFactory = SystemEventsFactory(organization_name=organization_name, factory_rest_client=rest_client)
...
class Tenant:
    ...
    def create(cls, username, user_password, organization_name, registration_password, prevention_mode: bool=True,
               local_admin_legacy: bool = False):
    ...
    def require_ownership_over_collector(self,
                                         source_collector: RestCollector,
