...
class UsersRest(BaseRestFunctionality):
    ...
    def create_user(self,
        ...
        if legacy:
            ...
            assert organization is not None, "Must pass organization name in order to invoke /users/create-user method"
            status, response = self._rest.passthrough.ExecuteRequest(url='/users/create-user',
                                                                     mode='post',
                                                                     body=user_data,
