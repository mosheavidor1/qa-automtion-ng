...
//                 description: '')
    ...
    triggers {
        parameterizedCron('''
            ...
            00 7,23 * * 0-4 % branchName=release/5.2.0.1; testim_branch=release/5.2.0.1; management_host_ip=10.151.25.75; collector_type=WINDOWS_7_32; tests_discover_type=suite; tests=sanity; report_results_to_jira=True; use_test_im_proxy=True; debug_mode=True; rest_api_user=enSiloCloudServices; rest_api_password=FMbPtlEczxL4YI99APFa18Rg; registration_password=4X2VAgyD7nfzvgalGUFC2GId; default_organization=sanity_5_2_0; upgrade_management_to_latest_build=False; upgrade_aggregator_to_latest_build=False; upgrade_core_to_latest_build=False; upgrade_collector_to_latest_build=True; retry_on_failure=True
